...
public sealed class CredentialCreateOptions : Fido2ResponseBase
{
    ...
    {
        Console.WriteLine("config.ServerDomain: " + config.ServerDomain);
        Console.WriteLine("config.ServerName: " + config.ServerName);
        Console.WriteLine("config.ServerIcon: " + config.ServerIcon);
