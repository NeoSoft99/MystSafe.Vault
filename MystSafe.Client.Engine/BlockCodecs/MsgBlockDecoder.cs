...
public class MsgBlockDecoder : MsgBlockValidator, IBlockDecoder<MsgBlockData>
{
    public MsgBlockData MsgDataUnpacked { get; set; }

    public MsgBlockDecoder(MsgBlock block) : base(block)
    {
    }
    ...
    public MsgBlockData DecodeMsgDataBySelf(SecKey chatPrivateKey, string recipientSecretPublicKey)
    {
        ...
        return new MsgBlockData(msg_data_decrypted);
    }
